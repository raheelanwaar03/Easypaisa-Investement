...
<!-- Mirrored from dolab.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Sep 2023 08:04:43 GMT -->
<head>
    <meta charset="utf-8">
							...
							<div class="card-header chat-list-header text-center">
								<a href="#" class="add" data-bs-toggle="modal" data-bs-target="#exampleModal">
									<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect fill="#ffffff" x="4" y="11" width="16" height="2" rx="1"/>
								...
								<a href="javascript:void(0);"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><circle fill="#ffffff" cx="5" cy="12" r="2"/><circle fill="#ffffff" cx="12" cy="12" r="2"/><circle fill="#ffffff" cx="19" cy="12" r="2"/></g></svg></a>
							</div>
			...
			<div class="dlabnav-scroll">
				...
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
						<div class="menu-icon">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path opacity="0.4" d="M11.7759 21.8374C9.49286 20.4273 7.37056 18.7645 5.44782 16.8796C4.09044 15.5338 3.0538 13.8905 2.4171 12.0753C1.27947 8.53523 2.60374 4.48948 6.30105 3.2884C8.25256 2.67553 10.375 3.05175 12.007 4.29983C13.6396 3.05315 15.7613 2.67705 17.7129 3.2884C21.4102 4.48948 22.7434 8.53523 21.6058 12.0753C20.9742 13.8888 19.9438 15.5319 18.5928 16.8796C16.6683 18.7625 14.5463 20.4251 12.2647 21.8374L12.0159 22L11.7759 21.8374Z" fill="#B9A8FF"/>
								<path d="M12.0109 22L11.776 21.8374C9.49013 20.4274 7.36487 18.7647 5.43902 16.8796C4.0752 15.5356 3.03238 13.8922 2.39052 12.0753C1.26177 8.53523 2.58605 4.48948 6.28335 3.2884C8.23486 2.67553 10.3853 3.05204 12.0109 4.31057V22Z" fill="#B9A8FF"/>
								<path d="M18.2304 9.99922C18.0296 9.98629 17.8425 9.8859 17.7131 9.72157C17.5836 9.55723 17.5232 9.3434 17.5459 9.13016C17.5677 8.4278 17.168 7.78851 16.5517 7.53977C16.1609 7.43309 15.9243 7.00987 16.022 6.59249C16.1148 6.18182 16.4993 5.92647 16.8858 6.0189C16.9346 6.027 16.9816 6.04468 17.0244 6.07105C18.2601 6.54658 19.0601 7.82641 18.9965 9.22576C18.9944 9.43785 18.9117 9.63998 18.7673 9.78581C18.6229 9.93164 18.4291 10.0087 18.2304 9.99922Z" fill="#763ed0"/>
							</svg>
						</div>
									...
									<div class="row gx-0">
										...
										<div class="col-xl-8 col-sm-6">
											<div class="card progressbar bg-transparent mb-0">
												<div class="card-header border-0 pb-0">
													<div>
														<h4 class="fs-18 font-w600 ">Earning Categories</h4>
														<span class="fs-14">Lorem ipsum dolor sit amet</span>
													</div>
												</div>
												<div class="card-body">
													<div class="progress default-progress">
														<div class="progress-bar linear bg-vigit progress-animated" style="width: 90%; height:8px;" role="progressbar">
															<span class="sr-only">90% Complete</span>
														</div>
													</div>
													<div class="d-flex align-items-end mt-2 pb-2 justify-content-between">
														<span class="fs-16 font-w600 value">#investement</span>
														<span><span class="text-black pe-2"></span>$ 89.24</span>
													</div>
													<div class="progress default-progress">
														<div class="progress-bar linear bg-contact progress-animated" style="width: 68%; height:8px;" role="progressbar">
															<span class="sr-only">45% Complete</span>
														</div>
													</div>
													<div class="d-flex align-items-end mt-2 pb-2 justify-content-between">
														<span class="fs-16 font-w600 value">#transfer</span>
														<span><span class="text-black pe-2"></span>$ 441.45</span>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-xl-4 col-sm-6 ">
											<div class="card tags bg-transparent">
												<div class="card-header border-0">
													<div>
														<h4 class="font-w600 fs-18">Others tag</h4>
														<span>Lorem ipsum dolor sit amet</span>
													</div>
												</div>
												<div class="card-body py-1">
													<div >
														<a href="javascript:voiud(0);" class="tag">#teamwork</a>
														<a href="javascript:voiud(0);" class="tag">#design</a>
														<a href="javascript:voiud(0);" class="tag">#projectmanagement</a>
														<a href="javascript:voiud(0);" class="tag">16+</a>
													</div>
						...
						<div class="card">
							<div class="row">
								...
								<div class="col-xl-12 col-lg-6">
									<div class="card-header border-0 pb-0">
										<div>
											<h4 class="mb-0 fs-18 font-w600">Others</h4>
											<span>Lorem ipsum dolor sit amet</span>
										</div>
									</div>
												...
												<div class="card">
													<div class="card-body p-3">
														<div class="align-items-center d-flex flex-wrap">
															<div class="d-inline-block position-relative donut-chart-sale me-1">
																<span class="donut2" data-peity='{ "fill": ["rgba(39, 174, 96, 1)", "rgba(255, 255, 255, 0.1"],   "innerRadius": 18, "radius": 8}'>3/9</span>
															</div>
															<div class="other-content">
																<h4 class="fs-18 font-w600 mb-1">Installment</h4>
											...
											<div class="col-xl-12 col-lg-12 col-md-6">
												<div class="card">
													<div class="card-body p-3">
														<div class="align-items-center d-flex flex-wrap">
															<div class="d-inline-block position-relative donut-chart-sale me-1">
																<span class="donut2" data-peity='{ "fill": ["rgba(253, 83, 83, 1)", "rgba(255, 255, 255, 0.1"],   "innerRadius": 18, "radius": 8}'>5/9</span>
															</div>
															<div class="other-content">
																<h4 class="fs-18 font-w600 mb-1">Investment</h4>
											...
											<div class="col-xl-12 col-lg-12 col-md-6">
												<div class="card">
													<div class="card-body p-3">
														<div class="align-items-center d-flex flex-wrap">
															<div class="d-inline-block position-relative donut-chart-sale me-1">
																<span class="donut2" data-peity='{ "fill": ["rgba(253, 191, 32, 1)", "rgba(255, 255, 255, 0.1"],   "innerRadius": 18, "radius": 8}'>5/6</span>
															</div>
															<div class="other-content">
																<h4 class="fs-18 font-w600 mb-1">Property</h4>
																<span class="fs-14">$3,784</span>
															</div>
														</div>
													</div>
								...
								<div class="col-xl-12 col-lg-6">
									<div class="card bg-transparent contacts mb-1">
										<div class="card-header border-0 pt-xl-0 pb-xl-0">
											<div>
												<h4 class="fs-18 font-w600">Contacts</h4>
												<span class="fs-14 font-w400">You have 245 clients</span>
											</div>
											<div>
												<a href="#" class="add" data-bs-toggle="modal" data-bs-target="#exampleModal">
										...
										<div class="card-body loadmore-content dz-scroll recent-activity-wrapper px-3  py-3" id="RecentActivityContent">
											...
											<div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
												...
												<div class="ms-2">
													<h6 class="font-w500 fs-16 mb-0"><a href="app-profile.html">Evans John</a></h6>
													<span class="fs-14 font-w400 text-wrap text-break">Programmer</span>
												</div>
												<div class="indox">
													<a href="#">
														<svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
												...
												<div class="ms-2">
													<h6 class="font-w500 fs-16 mb-0"><a href="app-profile.html">Brian Brandon</a></h6>
													<span class="fs-14 font-w400 text-wrap">Graphic Designer</span>
												</div>
												<div class="indox">
													<a href="#">
														<svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
												...
												<div class="ms-2">
													<h6 class="font-w500 fs-16 mb-0"><a href="app-profile.html">Bella Brownlee</a></h6>
													<span class="fs-14 font-w400 text-wrap">Software Engineer</span>
												</div>
												<div class="indox">
													<a href="#">
														<svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
												...
												<div class="ms-2">
													<h6 class="font-w500 fs-16 mb-0"><a href="app-profile.html">Chynthia Lawra</a></h6>
													<span class="fs-14 font-w400 text-wrap">CEO</span>
												</div>
												<div class="indox">
													<a href="#">
														<svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
												<span class="me-3 me-lg-2">
													<img src="images/profile/small/pic6.jpg" alt="" width="50">
												</span>
												<div class="ms-2">
													<h6 class="font-w500 fs-16 mb-0"><a href="app-profile.html">Dedi Cahyadi</a></h6>
													<span class="fs-14 font-w400 text-wrap">Head Manager</span>
										...
										<div class="card-footer text-center border-0 pt-0">
											<a href="javascript:void(0);" class="btn btn-block   dz-load-more" id="RecentActivity" rel="ajax/recentactivity.html">View More</a>
										</div>
									</div>
								</div>
								<!----/column-- -->
