                            ...
                            <div class="card-body py-0 custome-tooltip">
                                <div class="d-flex align-items-center flex-wrap income">
                                    ...
                                    <div class="d-flex align-items-center ms-sm-2 mb-2 arrow">
                                        <div class="me-3">
                                            <svg class="" width="45" height="45" viewBox="0 0 52 52"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="26" cy="26" r="26"
                                                    transform="rotate(-180 26 26)" fill="#5E3ED0" />
                                                <g clip-path="url(#clip0)">
                                                    <path
                            ...
                            <div class="card-header border-0 pb-4 arrow">
                                <div>
                                    ...
                                    <span class="d-inline-flex align-items-center"><small
                                            class="text-success font-w500 me-1">+1.6%</small> than last week</span>
                                </div>
                                <svg class="theme-col" width="45" height="45" viewBox="0 0 52 52"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="card progressbar bg-transparent mb-0">
                                        ...
                                        <div class="card-body">
                                            <div class="progress default-progress">
                                                <div class="progress-bar linear bg-vigit progress-animated"
                                            ...
                                            <div class="progress default-progress">
                                                <div class="progress-bar linear bg-contact progress-animated"
                    ...
                    <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="card-body p-3">
                                                <div class="align-items-center d-flex flex-wrap">
                                                    <div
                                                        class="d-inline-block position-relative donut-chart-sale me-1">
                                                        <span class="donut2"
                                                            data-peity='{ "fill": ["rgba(39, 174, 96, 1)", "rgba(255, 255, 255, 0.1"],   "innerRadius": 18, "radius": 8}'>3/9</span>
                                                    </div>
                                            ...
                                            <div class="card-body p-3">
                                                <div class="align-items-center d-flex flex-wrap">
                                                    <div
                                                        class="d-inline-block position-relative donut-chart-sale me-1">
                                                        <span class="donut2"
                                                            data-peity='{ "fill": ["rgba(253, 83, 83, 1)", "rgba(255, 255, 255, 0.1"],   "innerRadius": 18, "radius": 8}'>5/9</span>
                                                    </div>
                                                    <div class="other-content">
                                            ...
                                            <div class="card-body p-3">
                                                <div class="align-items-center d-flex flex-wrap">
                                                    <div
                                                        class="d-inline-block position-relative donut-chart-sale me-1">
                                                        <span class="donut2"
                                                            data-peity='{ "fill": ["rgba(253, 191, 32, 1)", "rgba(255, 255, 255, 0.1"],   "innerRadius": 18, "radius": 8}'>5/6</span>
                                                    </div>
                                                    <div class="other-content">
                        ...
                        <div class="col-xl-12 col-lg-6">
                            <div class="card bg-transparent contacts mb-1">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <label for="PersonName" class="form-label d-block">Enter
                                                            Name</label>
                                                        <input type="text" id="PersonName"
                                                            class="form-control w-100 mb-3" placeholder="Username">
                                                        <label for="PersonPosition" class="form-label d-block">Enter
                                                            Position</label>
                                                        <input type="text" id="PersonPosition"
                                                            class="form-control w-100" placeholder="Position">
                                ...
                                <div class="card-body loadmore-content dz-scroll recent-activity-wrapper px-3  py-3"
                                    ...
                                    <div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
                                        ...
                                        <div class="ms-2">
                                            <h6 class="font-w500 fs-16 mb-0"><a href="app-profile.html">Dedi
                                                    Cahyadi</a></h6>
                                    ...
                                    <div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
                                        ...
                                        <div class="ms-2">
                                            <h6 class="font-w500 fs-16 mb-0"><a href="app-profile.html">Evans John</a>
                                            </h6>
                                    ...
                                    <div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
                                        ...
                                        <div class="ms-2">
                                            <h6 class="font-w500 fs-16 mb-0"><a href="app-profile.html">Brian
                                                    Brandon</a></h6>
                                    ...
                                    <div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
                                        ...
                                        <div class="ms-2">
                                            <h6 class="font-w500 fs-16 mb-0"><a href="app-profile.html">Bella
                                                    Brownlee</a></h6>
                                    ...
                                    <div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
                                        ...
                                        <div class="ms-2">
                                            <h6 class="font-w500 fs-16 mb-0"><a href="app-profile.html">Chynthia
                                                    Lawra</a></h6>
                                ...
                                <div class="card-footer text-center border-0 pt-0">
                                    <a href="javascript:void(0);" class="btn btn-block   dz-load-more"
